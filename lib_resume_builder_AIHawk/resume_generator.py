...
class ResumeGenerator:
    ...
    def create_resume(self, style_path, temp_html_file):
        ...
        gpt_answerer = LLMResumer(global_config.API_KEY,global_config.AZURE_OPENAI_ENDPOINT, global_config.AZURE_OPENAI_DEPLOYMENT, global_config.API_VERSION, strings)
    ...
    def create_resume_job_description_url(self, style_path: str, url_job_description: str, temp_html_path):
        ...
        gpt_answerer = LLMResumeJobDescription(global_config.API_KEY,global_config.AZURE_OPENAI_ENDPOINT, global_config.AZURE_OPENAI_DEPLOYMENT,global_config.API_VERSION, strings)
