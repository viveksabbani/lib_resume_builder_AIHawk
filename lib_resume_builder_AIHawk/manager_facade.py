...
class FacadeManager:
    def __init__(self, api_key, azure_openai_endpoint, azure_openai_deployment, api_version, style_manager, resume_generator, resume_object, log_path):
        ...
        global_config.AZURE_OPENAI_ENDPOINT = azure_openai_endpoint
        global_config.AZURE_OPENAI_DEPLOYMENT = azure_openai_deployment,
        global_config.API_VERSION = api_version
